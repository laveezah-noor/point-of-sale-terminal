...
export default function NewEntryPage() {
    return (
        <div class=" bg-gray-100">
            ...
            <div class="bg-white rounded-2xl mt-8 p-8 w-3/4 mx-auto">
                <div>
        ...
        <div class="mt-5">
            ...
            <div class="flex items-center mt-5">
                ...
                <div class="mt-6">
                    ...
                    <textarea rows='10' cols='110' className='border-2 p-3 mt-4 rounded-xl'>Enter Description...</textarea>
                    {/* </div> */}
                    {/* </div> */}
                        ...
                        <div class="flex">
                            <div class="w-1/2">
                                ...
                                {/* <select class="h-12 mt-4 outline outline-1 outline-gray-400 text-lg px-4 rounded-xl">
                                    <option value="volvo">Enter Account</option>
