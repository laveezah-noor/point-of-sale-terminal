...
export default function EntriesPage() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:4000/getEntries`).then((response) => {
  ...
  return (
    <div class="flex flex-col items-center justify-between">
      <div class="">
        <p class="text-6xl font-semibold">Entries</p>
        <div className="mt-6">
          {/* <h1>Hi Clint</h1> */}
          <button
            style={{ backgroundColor: "#775DA6" }}
            onClick={changePage}
            class="h-12 w-40 ml-4 rounded-lg text-white"
          >
            New Entry
          </button>
        </div>
      ...
      <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5 w-full">
        <table class="table-auto mx-auto w-11/12 border-collapse bg-white text-left text-sm text-gray-500">
