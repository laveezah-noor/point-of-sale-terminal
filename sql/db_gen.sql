...
-- -----------------------------------------------------
-- Table `cash_flow_line_assignments`
-- -----------------------------------------------------

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `cash_flow_line_assignments` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `cash_flow_adjustments`
-- -----------------------------------------------------

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `cash_flow_adjustments` (
...
-- -----------------------------------------------------
-- Table `balance_and_income_lines`
-- -----------------------------------------------------

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `balance_and_income_lines` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `equity_columns`
-- -----------------------------------------------------

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `equity_columns` (
  `id` INT NOT NULL,
